...
export function Reviews({ dictionary }: { dictionary?: any }) {
   const t = (key: string) => dictionary?.reviews?.[key] || key;
   return (
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
               <div className="max-w-2xl">
                  <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tight mb-4">
                     {t('trusted_1')} <span className="text-red-600">{t('trusted_2')}</span>
                  </h2>
