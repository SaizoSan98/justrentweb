        ...
        <CardContent className="p-0">
          <div className="grid grid-cols-1 md:grid-cols-12 divide-y md:divide-y-0 md:divide-x divide-zinc-100">
            ...
            <div className="md:col-span-3 p-6 hover:bg-zinc-50 transition-colors cursor-pointer group">
              <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2 block group-hover:text-teal-600 transition-colors">
                Pick-up & Return
              </label>
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-zinc-400 group-hover:text-teal-600 transition-colors" />
                <div>
            ...
            <div className="md:col-span-4 p-6 hover:bg-zinc-50 transition-colors cursor-pointer group">
              <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2 block group-hover:text-teal-600 transition-colors">
               ...
               <div className="flex items-center gap-3">
                <CalendarIcon className="w-5 h-5 text-zinc-400 group-hover:text-teal-600 transition-colors" />
            ...
            {/* Car Type */}
             <div className="md:col-span-3 p-6 hover:bg-zinc-50 transition-colors cursor-pointer group">
              ...
              <div className="flex items-center gap-3">
                <Car className="w-5 h-5 text-zinc-400 group-hover:text-teal-600 transition-colors" />
                <select 
            ...
            <div className="md:col-span-2 p-4 flex items-center justify-center">
              <Button 
                ...
                className="w-full h-full min-h-[60px] bg-teal-500 hover:bg-teal-600 text-white font-bold text-lg uppercase tracking-wide rounded-xl shadow-lg shadow-teal-500/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                Search
              </Button>
            </div>
