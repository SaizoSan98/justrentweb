            ...
            {cars.map((car: any) => (
              <tr key={car.id} className="hover:bg-zinc-50/50 transition-colors">
                ...
                <td className="px-6 py-4 font-bold text-zinc-900">
                  ...
                  <span className="block text-[10px] text-zinc-400 font-normal">DB Ref.</span>
                </td>
                <td className="px-6 py-4">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold ${car.status === 'AVAILABLE' ? 'bg-green-100 text-green-800 border border-green-200' :
        ...
        {cars.map((car: any) => (
          <div key={car.id} className="p-4 bg-white">
            <div className="flex justify-between items-start mb-3">
              ...
              <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${car.status === 'AVAILABLE' ? 'bg-green-100 text-green-700' :
