...
export function FleetCard({
    ...
    return (
        <div className={cn(
            "group relative bg-gradient-to-b from-[#7f1d1d] via-[#18181b] to-[#18181b] border border-zinc-800/50 rounded-[2rem] overflow-hidden transition-all duration-500",
            isExpanded ? "shadow-2xl ring-1 ring-white/20 col-span-1 md:col-span-2 xl:col-span-3" : "hover:border-red-600/50 hover:shadow-[0_20px_60px_rgba(127,29,29,0.4)] hover:-translate-y-2",
