...
export function FleetCard({ 
  ...
  return (
        ...
        <DialogContent className="max-w-3xl bg-zinc-900 border-zinc-800 text-white">
            ...
            <div className="grid md:grid-cols-3 gap-6 py-4">
                            ...
                            {insuranceOptions.length > 0 ? insuranceOptions.map((option) => (
                                ...
                                >
                                    <div className="flex justify-between items-start mb-2">
                                        <h4 className="font-bold text-white">{option.plan.name}</h4>
                                        <span className="font-mono text-sm font-bold">
                                            {option.pricePerDay > 0 ? `+${option.pricePerDay}€/day` : "Included"}
                                        </span>
                                    </div>
                                    <p className="text-sm text-zinc-400 mb-3">{option.plan.description}</p>
                                ...
                                <div className="p-4 bg-zinc-800/50 rounded-xl border border-zinc-700 text-zinc-400 text-sm">
                ...
                <div className="md:col-span-1">
                    <div className="bg-zinc-950 rounded-xl p-6 border border-zinc-800 sticky top-4">
                        ...
                        <div className="space-y-4 text-sm">
                            ...
                            <div className="bg-zinc-900 rounded-lg p-3 text-xs text-zinc-500 mt-4">
                                <div className="flex justify-between mb-1">
                                    <span>Refundable Deposit:</span>
                                    <span className="text-white font-bold">{finalDeposit}€</span>
                                </div>
    ...
    <div className="group relative bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-none overflow-hidden transition-all duration-300">
      <div className="p-6">
        {/* Header */}
            ...
            <div className="flex flex-col justify-between h-full py-4">
                <div className="space-y-1">
                    <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-bold text-white">{pricePerDay.toLocaleString()} €</span>
                ...
                <div className="mt-8 space-y-3">
                    ...
                    <Button 
                        ...
                        className="w-full mt-4 bg-white text-black hover:bg-zinc-200 font-bold rounded-none h-12 text-lg"
                    >
                        CHOOSE
                    </Button>
                </div>
