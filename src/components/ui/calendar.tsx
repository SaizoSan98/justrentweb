...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-white rounded-lg shadow-sm border border-zinc-200", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-zinc-200 text-zinc-600 hover:bg-zinc-100 relative z-10"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-zinc-900 hover:bg-zinc-100"
        ),
